...
# Save
# save(p1, p2, type_freq, type_attack, type_sp_attack, summary_table, file = "Figures/data_description.RData")
...
# (pos1 + pos2) / (neg1 + neg2)
pc1_outliers = (pos1 + labs(title = "PC1 Positive Extreme: Wailord") +
              pos2 + labs(title = "PC1 Positive Extreme: Abomasnow")) /
             (neg1 + labs(title = "PC1 Negative Extreme: Elgyem") +
              neg2 + labs(title = "PC1 Negative Extreme: Geodude"))
print(pc1_outliers)
...
# exPlots = sapply(c(pos1, pos2, neg1, neg2), function(rgba) plotImg(getImg(rgba)))
# (pos1 + pos2) / (neg1 + neg2)
pc2_outliers = (pos1 + labs(title = "PC1 Positive Extreme: Slowking") +
              pos2 + labs(title = "PC1 Positive Extreme: Gardevoir")) /
             (neg1 + labs(title = "PC1 Negative Extreme: Altaria") +
              neg2 + labs(title = "PC1 Negative Extreme: Swablu"))
print(pc2_outliers)
...
pca_cumVE = barplot(ve)+
  ...
  geom_vline(xintercept = num_pcs, linetype = "dotted", color = "blue", size = 1) +  # Highlight selected PC count
